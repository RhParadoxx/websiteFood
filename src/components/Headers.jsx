  ...
  return (
    <div className="py-3 px-10 sm:px-4 md:px-6 lg:px-6">
      <div className="container mx-auto py-[16vh]">
        ...
        <div className="grid grid-cols-1 relative lg:grid-cols-2 gap-8 items-center">{/* container*/}
         
          <div className="lg:w-[32rem] w-full flex flex-col space-y-6"> {/* left*/}
            ...
            <div className="flex  flex-col sm:flex-row gap-8 items-center">
              <button className="bg-[#f54748] active:scale-90 transition duration-500 transform hover:shadow-md rounded-full px-8 py-2 text-xl font-medium text-white">Explore Now</button>
            ...
            <img src={headerImg}  className="h-[28rem] mx-auto justify-end"/> {/* right*/}
        </div>
      </div>
    </div>
  );
